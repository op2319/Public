...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, right_width in enumerate(f): 
            if x == 2:
...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, freq_left in enumerate(f): 
            if x == 3:
...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, freq_right in enumerate(f): 
            if x == 4:
...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, phase_left in enumerate(f): 
            if x == 6:
...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, phase_right in enumerate(f): 
            if x == 7:
...
for filepath in glob.glob(os.path.join(basedir, 'mf_w_*_w_*_s_*_op')):
    with open(filepath) as f:
        for x, phase_diff in enumerate(f): 
            if x == 8:
...
num_spac_list = num_spac_list * 1/1000
...
np.savetxt("bjet_int-data.txt", sorted_array , fmt = '%f')
